...
import { SalarySlider } from '@/components/ui/salary-slider';
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="overtime"
                      checked={watchedValues.overtime || false}
                      onCheckedChange={(checked) => form.setValue('overtime', checked as boolean)}
                    />
                    <Label htmlFor="overtime">Available for overtime work</Label>
                  </div>

                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="holidayWork"
                      checked={watchedValues.holidayWork || false}
                      onCheckedChange={(checked) => form.setValue('holidayWork', checked as boolean)}
                    />
                    <Label htmlFor="holidayWork">Available for holiday work</Label>
                  </div>

                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="visibility"
                      checked={watchedValues.visibility || false}
                      onCheckedChange={(checked) => form.setValue('visibility', checked as boolean)}
                    />
                    <Label htmlFor="visibility" className="flex items-center gap-2">
                      {watchedValues.visibility ? <Eye className="h-4 w-4" /> : <EyeOff className="h-4 w-4" />}
